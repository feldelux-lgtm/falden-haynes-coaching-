  ...
  singletons: {
    ...
    site_settings: singleton({
      ...
      schema: {
        ...
        whatsapp_url: fields.url({ label: 'WhatsApp URL', defaultValue: 'https://wa.me/447562614867' }),
        location: fields.text({ label: 'Location', defaultValue: 'Halesowen, West Midlands' }),
        linkedin_url: fields.url({ label: 'LinkedIn URL', defaultValue: 'https://www.linkedin.com/in/feldon-haynes/' }),
        linktree_url: fields.url({ label: 'Linktree URL', defaultValue: 'https://linktr.ee/Feldeluxe' }),
        trustpilot_url: fields.url({ label: 'Trustpilot URL', defaultValue: 'https://uk.trustpilot.com/review/feldonhaynes.com' }),
        google_reviews_url: fields.url({ label: 'Google Reviews URL', defaultValue: 'https://www.google.com/search?q=feldon+haynes+coaching' }),
        calendly_discovery: fields.url({ label: 'Calendly — Discovery call', defaultValue: 'https://calendly.com/feldeluxe/discovery-call' }),
        calendly_bundle_starter: fields.url({ label: 'Calendly — Starter bundle', defaultValue: 'https://calendly.com/feldeluxe/packages/da7fbbe4-840c-4ea8-8147-2128f99cfd6b' }),
        calendly_bundle_foundation: fields.url({ label: 'Calendly — Foundation bundle', defaultValue: 'https://calendly.com/feldeluxe/packages/549dd535-e12c-4506-822a-9a839af25318' }),
        calendly_bundle_action: fields.url({ label: 'Calendly — Action Sprint', defaultValue: 'https://calendly.com/feldeluxe/packages/8af8f4b4-b4fc-4b38-a4d7-4c8863f57ce5' }),
        calendly_bundle_full: fields.url({ label: 'Calendly — Full Transformation', defaultValue: 'https://calendly.com/feldeluxe/packages/bcd3e931-3e20-4faa-9d96-2a82cc4e121a' }),
      },
    }),
  ...
  collections: {
    ...
    bundles: collection({
      ...
      schema: {
        ...
        calendly_url: fields.url({ label: 'Calendly booking URL' }),
