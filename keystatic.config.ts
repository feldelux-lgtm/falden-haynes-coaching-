  ...
  singletons: {
    ...
    site_settings: singleton({
      ...
      schema: {
        ...
        calendly_discovery: fields.text({ label: 'Calendly — Discovery call', defaultValue: 'https://calendly.com/feldeluxe/discovery-call' }),
        calendly_bundle_starter: fields.text({ label: 'Calendly — Starter bundle', defaultValue: 'https://calendly.com/feldeluxe/packages/da7fbbe4-840c-4ea8-8147-2128f99cfd6b' }),
        calendly_bundle_foundation: fields.text({ label: 'Calendly — Foundation bundle', defaultValue: 'https://calendly.com/feldeluxe/packages/549dd535-e12c-4506-822a-9a839af25318' }),
        calendly_bundle_action: fields.text({ label: 'Calendly — Action Sprint', defaultValue: 'https://calendly.com/feldeluxe/packages/8af8f4b4-b4fc-4b38-a4d7-4c8863f57ce5' }),
        calendly_bundle_full: fields.text({ label: 'Calendly — Full Transformation', defaultValue: 'https://calendly.com/feldeluxe/packages/bcd3e931-3e20-4faa-9d96-2a82cc4e121a' }),
      },
    }),
